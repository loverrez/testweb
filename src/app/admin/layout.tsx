...
export default function AdminLayout({
  ...
  const menuCategories = [
    ...
    },
    {
      name: 'จัดการประกาศ',
      items: [
        { name: 'ตั้งค่าข้อความประกาศ', href: '/admin/announcements', icon: 'M11 5.882V19.297A2.453 2.453 0 018.828 21a2.45 2.45 0 01-1.769-.733 2.481 2.481 0 01-.731-1.767V5.882a2.474 2.474 0 01.731-1.767A2.447 2.447 0 018.828 3.382a2.458 2.458 0 012.172 2.5zM15.5 14a2 2 0 110-4 2 2 0 010 4z' },
      ],
    },
  ];
